...
const SIZE_GUIDE: Record<string, { columns: string[]; rows: string[][] }> = {
  ...
  suits: {
    columns: ['Size', 'Chest (cm)', 'Waist (cm)', 'Shoulder (cm)', 'Sleeve (cm)', 'Inseam (cm)'],
    rows: [
      ['S',   '92',  '76',  '42', '60', '76'],
      ['M',   '98',  '82',  '44', '62', '78'],
      ['L',   '104', '88',  '46', '64', '80'],
      ['XL',  '110', '94',  '48', '65', '81'],
      ['XXL', '116', '100', '50', '66', '82'],
    ],
  },
  corporate: {
    columns: ['Size', 'Chest (cm)', 'Waist (cm)', 'Shoulder (cm)', 'Sleeve (cm)', 'Inseam (cm)'],
  ...
  pants: {
    columns: ['Size', 'Waist (cm)', 'Hip (cm)', 'Inseam (cm)', 'Length (cm)'],
    rows: [
      ['S',   '76',  '96',  '78', '102'],
      ['M',   '82',  '102', '80', '104'],
      ['L',   '88',  '108', '82', '106'],
  ...
  jacket: {
    columns: ['Size', 'Chest (cm)', 'Shoulder (cm)', 'Length (cm)', 'Sleeve (cm)'],
    rows: [
      ['S',   '100', '43', '72', '62'],
      ['M',   '106', '45', '74', '64'],
      ['L',   '112', '47', '76', '65'],
  ...
  shirts: {
    columns: ['Size', 'Chest (cm)', 'Neck (cm)', 'Sleeve (cm)', 'Length (cm)'],
    rows: [
      ['S',   '102', '38', '63', '74'],
      ['M',   '108', '40', '64', '76'],
      ['L',   '114', '42', '65', '78'],
